...
fetch('/html/on-this-page.html')
  ...
  function textAppear() {
    ...
    if(textDiv.style.display === 'none' || textDiv.style.display === ''){
      ...
      button.innerHTML = 'Summary <img src="/images/ButtonComponents/minusIcon.png" alt="minus icon">'
    } else{
      textDiv.style.display = "none";
      button.innerHTML = 'Summary <img src="/images/buttonComponents/plusIcon.png" alt="plus icon">';
    }
  }
